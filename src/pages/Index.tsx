  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Hedera Agent Marketplace Showcase */}
        <section className="py-20 bg-gradient-to-br from-purple-500/5 via-blue-500/5 to-cyan-500/5">
          <Container>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <Badge variant="secondary" className="mb-4">
                🚀 Hedera Hackathon Innovation
              </Badge>
              <h2 className="text-3xl font-bold mb-4">A2A Agent Marketplace</h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                The world's first autonomous AI agent network for fraud verification, 
                powered by Hedera's ultra-fast blockchain
              </p>
            </motion.div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
              <Card className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-1">5 AI Agents</h3>
                <p className="text-sm text-muted-foreground">
                  Vision, Forensic, Metadata, Reputation, Reasoning
                </p>
              </Card>
              
              <Card className="p-6 text-center">
                <div className="text-3xl mb-2">⚡</div>
                <h3 className="font-semibold mb-1">3-5 Second TPS</h3>
                <p className="text-sm text-muted-foreground">
                  Instant consensus via Hedera HCS
                </p>
              </Card>
              
              <Card className="p-6 text-center">
                <div className="text-3xl mb-2">💰</div>
                <h3 className="font-semibold mb-1">$0.0001/tx</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <Card className="p-6 text-center">
                <div className="text-3xl mb-2">🔗</div>
                <h3 className="font-semibold mb-1">On-Chain Trust</h3>
                <p className="text-sm text-muted-foreground">
                  Reputation & payments on Hedera
                </p>
              </Card>
            </div>
